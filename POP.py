...
from utils import *
from DADAN_Datasets import TVdatasets_val
...
r20_a = 0
m20_a = 0
data_test=TVdatasets_val('data/A_domain.txt','data/B_domain.txt','data/test.txt',args,'M',3)
...
for idx,(b,target_a) in enumerate(data_loader_test):
    ...
    r20_a += recall[2]
    m20_a += mrr[2]
print('Recall5_a: {:.5f}; Mrr5: {:.5f}'.format(r5_a/len(data_test),m5_a/len(data_test)))
print('Recall10_a: {:.5f}; Mrr10: {:.5f}'.format(r10_a/len(data_test),m10_a/len(data_test)))
print('Recall20_a: {:.5f}; Mrr20: {:.5f}'.format(r20_a/len(data_test),m20_a/len(data_test)))
